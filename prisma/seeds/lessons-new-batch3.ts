...
export const newBatch3Lessons: TopicLessons[] = [
  ...
  // ═══════════════════════════════════════════════════════════════
  {
    ...
    layers: [
      ...
      },
      {
        ...
        mnemonics: [
          { text: "WHO = Well-being, Holistic, Overall", explanation: "WHO definition: Physical + Mental + Social well-being, not just absence of disease" },
          { text: "SSCE for natural history stages", explanation: "Susceptibility, Subclinical, Clinical, End-outcome (recovery/disability/death)" }
        ],
        keyPoints: [
          "WHO definition: complete physical, mental, social well-being",
          "Disease vs illness vs sickness: objective vs subjective vs social",
          "Socioeconomic factors contribute 50% to health determinants",
          "Natural history: susceptibility, subclinical, clinical, outcome",
          "PMJAY provides free treatment up to Rs 5 lakh"
        ],
        textbookRefs: [
          { book: "Park Textbook of Preventive & Social Medicine", chapter: "Ch 1-2", edition: "25th" }
        ]
  ...
  // ═══════════════════════════════════════════════════════════════
  {
    ...
    layers: [
      ...
      },
      {
        ...
        mnemonics: [
          { text: "PCBEP for occupational hazards", explanation: "Physical, Chemical, Biological, Ergonomic, Psychosocial" },
          { text: "SLUDGE for organophosphate toxicity", explanation: "Salivation, Lacrimation, Urination, Defecation, GI upset, Emesis" }
        ],
        keyPoints: [
          "Five types of occupational hazards: physical, chemical, biological, ergonomic, psychosocial",
          "Silicosis: eggshell calcification on CXR, latency 10-20 years",
          "Byssinosis: cotton dust, Monday fever",
          "Organophosphate poisoning: atropine + pralidoxime",
          "Factories Act 1948 is the main occupational safety law in India"
        ],
        textbookRefs: [
          { book: "Park Textbook of Preventive & Social Medicine", chapter: "Ch 16 - Occupational Health", edition: "25th" }
        ]
      }
    ]
  },
  ...
  // ═══════════════════════════════════════════════════════════════
  {
    ...
    layers: [
      ...
      },
      {
        ...
        mnemonics: [
          { text: "WHEAL for urticaria features", explanation: "Wheals <24h, Histamine driven, Edema of dermis, Allergic/autoimmune, Linear dermographism" },
          { text: "SJS-TEN severity scale", explanation: "SJS <10% BSA, SJS-TEN overlap 10-30%, TEN >30% body surface area" }
        ],
        keyPoints: [
          "Urticaria: transient pruritic wheals lasting <24 hours",
          "Acute vs chronic: 6 weeks cutoff",
          "Antihistamines are first-line treatment",
          "SJS/TEN: serious drug reactions with mucocutaneous involvement",
          "Culprit drugs: sulfonamides, NSAIDs, anticonvulsants, allopurinol"
        ],
        textbookRefs: [
          { book: "IADVL Textbook of Dermatology", chapter: "Ch 18 - Urticaria", edition: "4th" },
          { book: "Rook's Textbook of Dermatology", chapter: "Ch 42", edition: "9th" }
        ]
      }
    ]
  },
  ...
  // ═══════════════════════════════════════════════════════════════
  {
    ...
    layers: [
      ...
      },
      {
        ...
        mnemonics: [
          { text: "VITILIGO = Autoimmune T-cell destruction of melanocytes", explanation: "CD8+ T cells destroy melanocytes causing depigmented patches" },
          { text: "KP for Koebner Phenomenon", explanation: "New lesions at site of trauma; seen in vitiligo, psoriasis, lichen planus" }
        ],
        keyPoints: [
          "Vitiligo: acquired depigmentation from melanocyte loss",
          "Autoimmune mechanism: CD8+ T-cell mediated melanocyte destruction",
          "Koebner phenomenon positive",
          "Treatment: topical tacrolimus, NB-UVB phototherapy, corticosteroids",
          "Wood lamp shows chalky white fluorescence"
        ],
        textbookRefs: [
          { book: "IADVL Textbook of Dermatology", chapter: "Ch 36 - Vitiligo", edition: "4th" }
        ]
      }
    ]
  },
    ...
    layers: [
      {
        ...
        estimatedMinutes: 20,
        summary: "PEM: deficiency of protein and/or energy. Marasmus vs kwashiorkor. Most common nutritional deficiency globally.",
        contentMd: "# PEM Classification\n\n**Kwashiorkor**: Protein deficiency, adequate carbs\n- Edema, ascites, fatty liver\n- Hair depigmentation\n- Dermatitis\n\n**Marasmus**: Energy deficiency\n- Wasting, growth retardation\n- No edema\n- Loose skin\n\n**Marasmic-kwashiorkor**: Mixed\n\nIndia: High prevalence in rural areas, poor access to nutritious food",
        mnemonics: [{ text: "Kwashiorkor = edema; Marasmus = wasting", explanation: "K has fluid; M is malnourished" }],
        keyPoints: ["PEM leads to immunosuppression", "Edema present in kwashiorkor only", "Growth stunting and wasting in children", "Reversible if intervention early"],
        textbookRefs: [{ book: "Park Textbook of Preventive & Social Medicine", chapter: "Ch 10 - Malnutrition", edition: "25th" }
    ]
  },
      {
        layer: 2,
        ...
        estimatedMinutes: 30,
        summary: "Adaptive responses, immune dysfunction, metabolic changes in PEM.",
        contentMd: "# PEM Pathophysiology\n\n## Metabolic Adaptation\n- Reduced basal metabolic rate (20-30%)\n- Decreased protein synthesis\n- Liver glycogen depletion\n- Muscle breakdown for gluconeogenesis\n\n## Immune Dysfunction\n- Impaired cell-mediated immunity\n- Reduced antibody response\n- Decreased complement levels\n- Opportunistic infections\n\n## Organ-Specific Changes\n- **Liver**: Fatty infiltration, cirrhosis\n- **Heart**: Dilated cardiomyopathy\n- **GI**: Villous atrophy, reduced absorption\n- **Thyroid**: Reduced T3, TSH\n\n## Kwashiorkor Specifics\n- Albumin significantly decreased\n- Edema from osmotic changes\n- Fatty liver (hepatic steatosis)\n\n## Refeeding Syndrome Risk\n- Hypophosphatemia, hypokalemia\n- Cardiac arrhythmias\n- Fluid overload",
        mnemonics: [{ text: "FISH for refeeding syndrome", explanation: "Fluid, Insulin, Shifts, Hypophosphatemia" }],
        keyPoints: ["Metabolic rate decreased 20-30%", "Cell-mediated immunity impaired", "Albumin significantly low in kwashiorkor", "Refeeding must be gradual", "Villous atrophy reduces absorption"],
        textbookRefs: [{ book: "Park Textbook", chapter: "Ch 10", edition: "25th" }
    ]
  },
      {
        layer: 3,
  ...
  },
      {
        ...
        estimatedMinutes: 15,
        summary: "High-yield facts on PEM classification and management.",
        contentMd: "# High-Yield Points\n\n**Kwashiorkor Features**: Edema, ascites, fatty liver, skin changes\n**Marasmus**: Wasting, no edema, skin and bones visible\n\n**IAP Classification**: 51-70% = Grade I, <30% = Grade IV\n\n**Management**: Gradual caloric increase, micronutrients\n\n**Complication**: Refeeding syndrome (hypophosphatemia, hypokalemia)\n\n**Prevention**: ICDS, school nutrition",
        mnemonics: [{ text: "K = Kwashiorkor with edema; M = Marasmus without", explanation: "Edema differentiates the two" }],
        keyPoints: ["Edema diagnostic of kwashiorkor", "Gradual nutrition critical", "Infections common cause of death", "Micronutrients (vitamin A) prevent xerophthalmia", "Early treatment prevents permanent disability"],
        textbookRefs: [{ book: "Park Textbook", chapter: "Ch 10", edition: "25th" }
    ]
  },
      {
        ...
        estimatedMinutes: 10,
        summary: "Quick recall on PEM types and management.",
        ...
        mnemonics: [{ text: "K = Kwashiorkor = Edema; M = Marasmus = Muscle wasting", explanation: "Kwashiorkor: protein deficiency with edema; Marasmus: energy deficiency with wasting" }, { text: "FISH for refeeding syndrome", explanation: "Fluid overload, Insulin surge, Shifts in electrolytes, Hypophosphatemia" }],
        keyPoints: ["Kwashiorkor: edema, fatty liver, depigmented hair; marasmus: severe wasting without edema", "IAP grading: Grade I (51-70%), II (41-50%), III (31-40%), IV (<30%)", "Refeeding syndrome risk: hypophosphatemia, hypokalemia, cardiac arrhythmias", "Treatment: gradual caloric increase (10-15 kcal/kg/day initially)", "Prevention: ICDS, anganwadi centers, school nutrition programs"],
        textbookRefs: [{ book: "OP Ghai Essential Pediatrics", chapter: "Ch 5 - Nutrition", edition: "9th" }, { book: "Park Textbook of Preventive & Social Medicine", chapter: "Ch 10", edition: "25th" }]
      }
    ]
  },
  ...
  // Remaining 5 topics in concise format to complete 20 total
  {
    ...
    layers: [
      {
        layer: 1,
        slug: "anthelmintics-foundation",
        title: "Anthelmintics & Antiprotozoals - Foundation",
        estimatedMinutes: 20,
        summary: "Drugs for helminths and protozoa. Classification and mechanisms of action against parasites.",
  ...
  },
      {
        ...
        mnemonics: [{ text: "APM for antiparasitic drugs", explanation: "Albendazole (helminths), Praziquantel (tapeworms/flukes), Metronidazole (protozoans)" }, { text: "ACT = Artemisinin Combination Therapy", explanation: "Gold standard for P. falciparum malaria treatment" }],
        keyPoints: ["Albendazole 400mg single dose: first-line for Ascaris, hookworm", "Praziquantel: tapeworms and flukes; contraindicated in neurocysticercosis", "Artesunate IV: drug of choice for severe malaria", "Primaquine prevents P. vivax relapse (kills hypnozoites)", "Metronidazole: standard treatment for amoebiasis and giardiasis"],
        textbookRefs: [{ book: "KD Tripathi Essentials of Medical Pharmacology", chapter: "Ch 44-45 - Antimalarials & Anthelmintics", edition: "9th" }]
      }
    ]
  },
  ...
  // Final 4 topics in condensed format
  {
    ...
    layers: [
  ...
  },
      {
        ...
        mnemonics: [{ text: "PTU = Pregnancy Thyroid drug (1st trimester)", explanation: "PTU preferred in first trimester; carbimazole/methimazole for rest of pregnancy and general use" }, { text: "THYROID storm treatment = BIS", explanation: "Beta-blocker + Iodine (Lugol) + Steroids + PTU" }],
        keyPoints: ["Levothyroxine: drug of choice for hypothyroidism; take empty stomach", "Carbimazole/methimazole: first-line antithyroid drugs", "PTU: preferred in first trimester pregnancy and thyroid storm", "Radioactive iodine (I-131): definitive treatment for Graves disease", "Thyroid storm: propranolol + PTU + Lugol iodine + hydrocortisone"],
        textbookRefs: [{ book: "KD Tripathi Essentials of Medical Pharmacology", chapter: "Ch 20 - Thyroid Hormones & Antithyroid Drugs", edition: "9th" }]
      }
    ]
  },
  ...
  // 19. PH-MOD-08-TOP-04: Drugs Acting on Uterus & Blood
  {
    ...
    layers: [
  ...
  },
      {
        ...
        mnemonics: [{ text: "Oxytocin for OB; Heparin for pregnancy", explanation: "Safe profiles in special populations" }],
        keyPoints: ["Oxytocin 2-10 mU/min IV titration", "aPTT goal heparin: 1.5-2.5x", "INR goal warfarin: 2-3 (valves: 2.5-3.5)", "Heparin preferred in pregnancy", "HIT risk with heparin (check platelet count)"],
        textbookRefs: [{ book: "KDT Pharmacology", chapter: "Ch 31-32", edition: "9th" }
    ]
  },
      {
        layer: 5,
        slug: "uterotonic-anticoagulant-recall",
        title: "Drugs Acting on Uterus & Blood - Active Recall",
        estimatedMinutes: 10,
        summary: "Quick recall on uterotonic and anticoagulant drugs.",
        ...
        mnemonics: [{ text: "OXYTOCIN = first-line for PPH prevention", explanation: "Oxytocin 10 IU IM during third stage of labor prevents PPH" }, { text: "Heparin = LMWH preferred; Warfarin = monitor INR", explanation: "LMWH: no monitoring needed; warfarin: target INR 2-3" }],
        keyPoints: ["Oxytocin: first-line uterotonic for PPH prevention and treatment", "Misoprostol: alternative uterotonic where oxytocin unavailable", "Ergometrine: contraindicated in hypertension and heart disease", "Heparin: immediate anticoagulation; LMWH preferred for DVT prophylaxis", "Warfarin: oral anticoagulant; teratogenic (contraindicated in pregnancy)"],
        textbookRefs: [{ book: "KD Tripathi Essentials of Medical Pharmacology", chapter: "Ch 22, 31 - Uterotonics & Anticoagulants", edition: "9th" }]
      }
    ]
  },
  ...
  // 20. PY-MOD-01-TOP-04: Body Fluids & Compartments
  {
    ...
    layers: [
      ...
      },
      {
        ...
        mnemonics: [
          { text: "60-40-20 rule for body water", explanation: "TBW=60% body weight, ICF=40%, ECF=20% (plasma=5%, ISF=15%)" },
          { text: "ICF = K+, Mg2+, PO4; ECF = Na+, Cl-, HCO3-", explanation: "Intracellular fluid is rich in potassium; extracellular is rich in sodium" }
        ],
        keyPoints: [
          "Total body water: 60% of body weight in adult males",
          "ICF:ECF ratio is 2:1 (40%:20%)",
          "ICF major cation: K+; ECF major cation: Na+",
          "Plasma volume measured by Evans blue dye or radiolabeled albumin",
          "Donnan equilibrium governs ion distribution across capillary membranes"
        ],
        textbookRefs: [
          { book: "Guyton & Hall Textbook of Medical Physiology", chapter: "Ch 25 - Body Fluid Compartments", edition: "14th" },
          { book: "AK Jain Textbook of Physiology", chapter: "Ch 1", edition: "8th" }
        ]
      }
    ]
  },
  ...
  // Final topic 21: SU-MOD-06-TOP-04: Pancreatic Tumors
  {
    ...
    layers: [
      ...
      },
      {
        ...
        mnemonics: [
          { text: "Courvoisier law = Painless jaundice + palpable GB", explanation: "Palpable gallbladder with painless jaundice suggests malignant obstruction, not gallstones" },
          { text: "Whipple procedure = pancreaticoduodenectomy", explanation: "Remove head of pancreas, duodenum, distal bile duct, gallbladder" }
        ],
        keyPoints: [
          "Pancreatic adenocarcinoma: 85-90% of pancreatic malignancies; poor prognosis",
          "Head of pancreas tumors: painless obstructive jaundice (Courvoisier sign)",
          "CA 19-9: tumor marker for pancreatic cancer",
          "Whipple procedure: surgery for resectable pancreatic head tumors",
          "5-year survival <10% overall; gemcitabine-based chemotherapy for advanced disease"
        ],
        textbookRefs: [
          { book: "Bailey & Love Short Practice of Surgery", chapter: "Ch 67 - Pancreas", edition: "28th" },
          { book: "SRB Manual of Surgery", chapter: "Ch - Pancreatic Tumors", edition: "6th" }
        ]
      }
    ]
  }
